...
const Restablecer = () => {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            const url = `${process.env.VITE_BACKEND_URL}/usuario/nuevo-password/${token}`;
    ...
    const verifyToken = async () => {
        try {
            const url = `${process.env.VITE_BACKEND_URL}/usuario/recuperar-password/${token}`;
    ...
    return (
        <div
            ...
            className="min-h-screen w-full flex justify-center items-center bg-[url('/public/images/paginalogin.png')] bg-no-repeat bg-cover bg-center"
        >
                ...
                <div className="bg-gray-900 bg-opacity-90 p-8 rounded-lg shadow-lg w-full max-w-3xl flex flex-col items-center justify-center">
                    ...
                    <form className='w-full' onSubmit={handleSubmit}>
                        <div className="mb-4">
                            ...
                            />
                            <label htmlFor="confirmpassword" className="mb-2 block text-sm font-semibold mt-4">Confirmar contraseña</label>
                            <input
                                type="password"
                                id="confirmpassword"
